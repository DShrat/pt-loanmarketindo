            ...
            <section className=' flex flex-col col-span-6'>
                ...
                {!highlight ? (
                    <section>
                        ...
                        <section className="flex flex-row flex-wrap mx-8 gap-10 cursor-pointer xs:text-xs lg:text-base">
                                        ...
                                        <section className='grid grid-cols-2 xs:text-xs md:text-sm mx-10'>
                                            ...
                                            <div className='grid grid-cols-1 gap-3'>
                                                <div className="flex gap-2">
                                                    ...
                                                    <p>Fix Rate (year): {item.FixRate}</p>
                                                </div>
                                                <div className="flex gap-2">
                                                    <div>
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <p>loan to value: {item.LoanToValue}</p>
                                                </div>
                                            </div>
                                            <div className='grid grid-cols-1 gap-3'>
                                                <div className="flex gap-2">
